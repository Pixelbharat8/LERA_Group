...
// Parent Panel Access Control Layout
const ALLOWED_ROLES = ["CHAIRMAN", "CEO", "DIRECTOR", "SUPER_ADMIN", "SUPERADMIN", "CENTER_ADMIN", "CENTER_MANAGER", "PARENT"];
...
export default function ParentLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const checkAuthorization = () => {
      ...
      if (!hasAccess) {
        console.warn(`Access denied to Parent Panel: User role ${normalizedRole} not allowed`);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg max-w-md">
          ...
          <p className="text-gray-600 mb-4">
            You don't have permission to access the Parent Panel.
          </p>
