    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
          <Link href="/dashboard/parent" className="hover:text-blue-600">
            Dashboard
          </Link>
          <span>/</span>
        ...
        <p className="text-sm text-gray-500 mt-1">Notifications and messages for your account</p>
      </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="border-b pb-4 mb-4">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                  ...
                  <div>
                    <span className="font-medium">Type:</span> {selectedMessage.senderRole}
                  </div>
                  <div>
