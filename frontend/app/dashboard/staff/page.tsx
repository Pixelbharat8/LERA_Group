...
export default function StaffDashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div><h1 className="text-3xl font-bold text-gray-800">{t("staffDashboard")}</h1><p className="text-gray-600">{t("welcomeStaff")}, {user?.fullname || user?.firstName || "Staff"}!</p></div>
