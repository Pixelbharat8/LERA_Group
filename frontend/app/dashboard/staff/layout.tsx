...
// Staff Panel Access Control Layout
// Accessible by STAFF role and above

const ALLOWED_ROLES = ["CHAIRMAN", "CEO", "DIRECTOR", "SUPER_ADMIN", "SUPERADMIN", "CENTER_ADMIN", "CENTER_MANAGER", "STAFF"];
...
export default function StaffLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const checkAuthorization = () => {
      ...
      if (!hasAccess) {
        console.warn(`Access denied to Staff Panel: User role ${normalizedRole} not allowed`);
