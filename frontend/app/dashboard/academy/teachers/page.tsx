...
export default function TeachersPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: "",
    centerId: "",
    // Public "Meet our Teachers" profile fields
    displayName: "",
    displayNameVi: "",
    photoUrl: "",
    bioVi: "",
  ...
  const handleEdit = (teacher: Teacher) => {
    ...
    setFormData({
      ...
      displayNameVi: teacher.displayNameVi || "",
      photoUrl: teacher.photoUrl || "",
      bioVi: teacher.bioVi || "",
      isFeatured: teacher.isFeatured ?? false,
      isNativeSpeaker: teacher.isNativeSpeaker ?? false
    });
...
// Public "Meet our Teachers" profile fields — shared by the Add and Edit modals.
// A teacher appears on the public /teachers page only when Display name is set.
function PublicProfileFields({ formData, setFormData }: { formData: any; setFormData: (v: any) => void }) {
  ...
  return (
    <div className="border-t pt-4 mt-2">
      ...
      <p className="text-xs text-gray-500 mb-3">Shown on the public Teachers page. A teacher appears there only once a Display name is set.</p>
      <div className="grid grid-cols-2 gap-4">
        <div>
