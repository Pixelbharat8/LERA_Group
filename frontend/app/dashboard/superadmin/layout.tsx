...
// SuperAdmin Panel Access Control Layout
...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    const checkAuthorization = () => {
      ...
      if (!hasAccess) {
        console.warn(`Access denied to Super Admin Panel: User role ${normalizedRole} not allowed`);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600">Verifying access to Super Admin Panel...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center bg-white rounded-xl shadow-lg p-8 max-w-md">
          ...
          <p className="text-gray-600 mb-2">
            You don't have permission to access the <strong>Super Admin Panel</strong>.
          </p>
