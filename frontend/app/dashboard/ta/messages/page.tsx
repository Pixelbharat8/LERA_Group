    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Communications from teachers and administration</p>
        </div>
      </div>
                ...
                filteredMessages.map((message) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <div className="font-medium text-gray-900 truncate">{message.sender}</div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="border-b border-gray-200 pb-4 mb-4">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600">
                  ...
                  <div>
                    <span className="font-medium">Role:</span> {selectedMessage.senderRole}
                  </div>
                  <div>
