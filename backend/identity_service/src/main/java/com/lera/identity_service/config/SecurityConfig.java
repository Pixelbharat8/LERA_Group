    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/login", "/api/auth/register", "/api/auth/provision-user", "/api/auth/set-password-link", "/api/auth/health", "/api/auth/refresh", "/api/auth/logout").permitAll()
