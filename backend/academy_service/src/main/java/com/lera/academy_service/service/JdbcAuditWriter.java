 ...
 * shared {@code audit_logs} Postgres table — see the identical class in
 * payment_service for full notes.
 */
@Service
...
public class JdbcAuditWriter {
    ...
    public void log(String action, String entityType, UUID entityId,
        ...
        try {
            ...
            jdbc.update(
                    ...
                    new int[] {
                        Types.VARCHAR, Types.VARCHAR, Types.OTHER, Types.OTHER,
    ...
    private HttpServletRequest currentRequest() {
        ...
        } catch (Exception ignored) { /* outside request scope */ }
        return null;
    }
}
