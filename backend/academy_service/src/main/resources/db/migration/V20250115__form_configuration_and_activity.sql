...
-- Supply id explicitly (gen_random_uuid()): when the FormConfiguration JPA entity has already
-- created this table via ddl-auto (Phase-1 bootstrap / dev flyway-off), the id column has NO DB
-- default (@GeneratedValue is app-side), so relying on the column DEFAULT fails with a not-null
-- violation. Providing the id works in both the migration-first and entity-first cases.
INSERT INTO form_configurations (id, form_name, entity_type, description, fields) VALUES
(gen_random_uuid(), 'student_registration', 'STUDENT', 'Student Registration Form', '[
...
(gen_random_uuid(), 'teacher_registration', 'TEACHER', 'Teacher Registration Form', '[
    {"name": "fullName", "label": "Full Name", "type": "text", "required": true, "order": 1},
    {"name": "email", "label": "Email Address", "type": "email", "required": true, "order": 2},
...
(gen_random_uuid(), 'staff_registration', 'STAFF', 'Staff Registration Form', '[
    {"name": "fullName", "label": "Full Name", "type": "text", "required": true, "order": 1},
    {"name": "email", "label": "Email Address", "type": "email", "required": true, "order": 2},
    {"name": "phone", "label": "Phone Number", "type": "text", "required": false, "order": 3},
...
(gen_random_uuid(), 'parent_registration', 'PARENT', 'Parent/Guardian Registration Form', '[
    {"name": "fullName", "label": "Full Name", "type": "text", "required": true, "order": 1},
    {"name": "email", "label": "Email Address", "type": "email", "required": true, "order": 2},
    {"name": "phone", "label": "Phone Number", "type": "text", "required": true, "order": 3},
...
(gen_random_uuid(), 'center_registration', 'CENTER', 'Center Registration Form', '[
...
(gen_random_uuid(), 'class_registration', 'CLASS', 'Class Registration Form', '[
